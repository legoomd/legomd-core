...
class LegomdAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _LegomdAppBarState createState() => _LegomdAppBarState();
}

class _LegomdAppBarState extends State<LegomdAppBar> {
